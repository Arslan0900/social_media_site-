...
const RightBar = () => {
  return (
    <Box  p={5} pt={8} flex={2} sx={{display:{xs:"none",md:"Block"}}}>
    ...
    <Typography variant='h6' fontWeight={100} mb={2} mt={2}>Latest pictures</Typography>
...
<Typography variant='h6' fontWeight={100} mb={-1} mt={2}>Latest Conversations</Typography>
